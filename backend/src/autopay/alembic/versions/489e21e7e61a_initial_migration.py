...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_processed_payments_message_id"), "processed_payments", ["message_id"], unique=False
    )
    op.create_index(
        op.f("ix_processed_payments_chat_username"),
        "processed_payments",
        ["chat_username"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_unparsed_messages_message_id"), "unparsed_messages", ["message_id"], unique=False
    )
    op.create_index(
        op.f("ix_unparsed_messages_chat_username"),
        "unparsed_messages",
        ["chat_username"],
        unique=False,
    )
